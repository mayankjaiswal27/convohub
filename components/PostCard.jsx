...
>>>>>>> parent of c2ddf1b (Like, Share & Pagination)
const PostCard = ({
  item,
  currentUser,
  router,
    ...
    <View style={[styles.container, hasShadow && shadowStyles ]}>
      ...
      <View style={styles.content}>
        ...
        }
        {
          item?.file && item?.file?.includes('postVideos') &&(
            ...
            source={
              {uri:getSupabaseFileUrl(item?.file)}}
            useNativeControls
            resizeMode='cover'
            isLooping
            />
      ...
      <View style={styles.footer}>
        <View style={styles.footerButton}>
          <TouchableOpacity>
            <Icon name="heart" size={22} fill={liked?theme.colors.rose:"transparent"} color={liked?theme.colors.rose:theme.colors.textLight} strokeWidth={2}/>
          </TouchableOpacity>
